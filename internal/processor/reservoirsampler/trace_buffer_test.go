...
// TestTraceBufferAddAndGet tests adding spans to and retrieving them from the trace buffer
...
// TestTraceBufferCompletedTraces tests the identification and retrieval of completed traces
...
// TestTraceBufferEviction tests that traces are properly evicted when the buffer is full
...
// TestTraceBufferConcurrentAccess tests that the trace buffer is thread-safe
